...
def draw_boxes(
    ...
    for i, box in enumerate(bbox):
        ...
        tl = (
            opt.thickness or round(0.002 * (img.shape[0] + img.shape[1]) / 2) + 1
        )  # line/font thickness
                        ...
                        if opt.show_track:
                            ...
                            for t, track in enumerate(tracks):
                                ...
                                track_color = (
                                    ...
                                    if not opt.unique_track_color
                                    else sort_tracker.color_list[t]
                                )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--thickness", type=int, default=2, help="bounding box and font size thickness"
    )
    parser.add_argument(
        "--seed", type=int, default=1, help="random seed to control bbox colors"
    )
